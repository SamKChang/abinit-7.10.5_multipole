# Generated by make-macros-fallbacks on 2015/10/19 06:29:13 +0000
...
AC_DEFUN([ABI_FALLBACK_ATOMPAW],[
  ...
  atompaw_pkg_name="atompaw-4.0.0.10"
  AC_SUBST(atompaw_pkg_name)
  atompaw_pkg_string="AtomPAW version 4.0.0.10 (upstream release)"
  ...
  AC_ARG_ENABLE([ATOMPAW],
    AC_HELP_STRING([--enable-atompaw],
      [AtomPAW version 4.0.0.10 (upstream release)]))
  ...
  if test "${enable_atompaw}" = "yes"; then
    ...
    if test "${with_atompaw_libs}" = ""; then
      ...
      if test -s "${abinit_tardir}/atompaw-4.0.0.10.tar.gz"; then
        AC_MSG_RESULT([yes])
        AX_CHECK_MD5SUM([${abinit_tardir}/atompaw-4.0.0.10.tar.gz],[533a4ecaee5b23450d19128e64b13589])
        case "${abi_md5_ok}" in
          yes)
            afb_tarball="yes"
      ...
      if test "${afb_ready}" = "no"; then
        for dl_url in "http://www.wfu.edu/~natalie/papers/pwpaw/atompaw-4.0.0.10.tar.gz" "http://forge.abinit.org/fallbacks/atompaw-4.0.0.10.tar.gz"; do
          if test "${afb_tarball}" = "no"; then
            AC_MSG_NOTICE([downloading ATOMPAW - this may take a while])
            rm -f "${abinit_tardir}/atompaw-4.0.0.10.tar.gz"
            ${afb_downloader} ${afb_dlopts}               "${abinit_tardir}/atompaw-4.0.0.10.tar.gz"               "${dl_url}"
            if test -s "${abinit_tardir}/atompaw-4.0.0.10.tar.gz"; then
              AX_CHECK_MD5SUM([${abinit_tardir}/atompaw-4.0.0.10.tar.gz],[533a4ecaee5b23450d19128e64b13589])
              case "${abi_md5_ok}" in
                yes)
...
AC_DEFUN([ABI_FALLBACK_BIGDFT],[
  ...
  dnl Define variables needed to build the package
  bigdft_pkg_name="bigdft-1.7.0.93"
  AC_SUBST(bigdft_pkg_name)
  bigdft_pkg_string="BigDFT library 1.7.0.93 (upstream release)"
  AC_SUBST(bigdft_pkg_string)

  dnl Define options associated to the package
  AC_ARG_ENABLE([BIGDFT],
    AC_HELP_STRING([--enable-bigdft],
      [BigDFT library 1.7.0.93 (upstream release)]))
  ...
  if test "${enable_bigdft}" = "yes"; then
    ...
    if test "${with_bigdft_incs}" = "" -o "${with_bigdft_libs}" = ""; then
      ...
      if test -s "${abinit_tardir}/bigdft-1.7.0.93.tar.gz"; then
        AC_MSG_RESULT([yes])
        AX_CHECK_MD5SUM([${abinit_tardir}/bigdft-1.7.0.93.tar.gz],[2300b5a8c4dfc13b9e602b97c533f5c8])
        case "${abi_md5_ok}" in
          yes)
            afb_tarball="yes"
            AC_MSG_NOTICE([tarball MD5 check succeeded])
      ...
      dnl Get the package
      if test "${afb_ready}" = "no"; then
        for dl_url in "http://inac.cea.fr/L_Sim/BigDFT/bigdft-1.7.0.93.tar.gz"; do
          if test "${afb_tarball}" = "no"; then
            AC_MSG_NOTICE([downloading BIGDFT - this may take a while])
            rm -f "${abinit_tardir}/bigdft-1.7.0.93.tar.gz"
            ${afb_downloader} ${afb_dlopts}               "${abinit_tardir}/bigdft-1.7.0.93.tar.gz"               "${dl_url}"
            if test -s "${abinit_tardir}/bigdft-1.7.0.93.tar.gz"; then
              AX_CHECK_MD5SUM([${abinit_tardir}/bigdft-1.7.0.93.tar.gz],[2300b5a8c4dfc13b9e602b97c533f5c8])
              case "${abi_md5_ok}" in
                yes)
...
AC_DEFUN([ABI_FALLBACK_FOX],[
  ...
  if test "${enable_fox}" = "yes"; then
    ...
    if test "${with_fox_incs}" = "" -o "${with_fox_libs}" = ""; then
      ...
      dnl Get the package
      if test "${afb_ready}" = "no"; then
        for dl_url in "http://www1.gly.bris.ac.uk/~walker/FoX/source/FoX-4.1.2.tar.gz" "http://forge.abinit.org/fallbacks/FoX-4.1.2.tar.gz"; do
          if test "${afb_tarball}" = "no"; then
...
AC_DEFUN([ABI_FALLBACK_LIBXC],[
  ...
  dnl Define variables needed to build the package
  libxc_pkg_name="libxc-2.0.3"
  AC_SUBST(libxc_pkg_name)
  libxc_pkg_string="LibXC library 2.0.3 (upstream release)"
  AC_SUBST(libxc_pkg_string)

  dnl Define options associated to the package
  AC_ARG_ENABLE([LIBXC],
    AC_HELP_STRING([--enable-libxc],
      [LibXC library 2.0.3 (upstream release)]))
  ...
  if test "${enable_libxc}" = "yes"; then
    ...
    if test "${with_libxc_incs}" = "" -o "${with_libxc_libs}" = ""; then
      ...
      if test -s "${abinit_tardir}/libxc-2.0.3.tar.gz"; then
        AC_MSG_RESULT([yes])
        AX_CHECK_MD5SUM([${abinit_tardir}/libxc-2.0.3.tar.gz],[f23586d54a5e73e7aa634560c9bab3e9])
        case "${abi_md5_ok}" in
          yes)
            afb_tarball="yes"
            AC_MSG_NOTICE([tarball MD5 check succeeded])
      ...
      dnl Get the package
      if test "${afb_ready}" = "no"; then
        for dl_url in "http://www.tddft.org/programs/octopus/down.php?file=libxc/libxc-2.0.3.tar.gz" "http://forge.abinit.org/fallbacks/libxc-2.0.3.tar.gz"; do
          if test "${afb_tarball}" = "no"; then
            AC_MSG_NOTICE([downloading LIBXC - this may take a while])
            rm -f "${abinit_tardir}/libxc-2.0.3.tar.gz"
            ${afb_downloader} ${afb_dlopts}               "${abinit_tardir}/libxc-2.0.3.tar.gz"               "${dl_url}"
            if test -s "${abinit_tardir}/libxc-2.0.3.tar.gz"; then
              AX_CHECK_MD5SUM([${abinit_tardir}/libxc-2.0.3.tar.gz],[f23586d54a5e73e7aa634560c9bab3e9])
              case "${abi_md5_ok}" in
                yes)
...
AC_DEFUN([ABI_FALLBACK_WANNIER90],[
  ...
  if test "${enable_wannier90}" = "yes"; then
    ...
    if test "${with_wannier90_libs}" = ""; then
      ...
      dnl Get the package
      if test "${afb_ready}" = "no"; then
        for dl_url in "http://forge.abinit.org/fallbacks/wannier90-1.2.0.1.tar.gz" "http://ypouillon.free.fr/abinit/wannier90-1.2.0.1.tar.gz"; do
          if test "${afb_tarball}" = "no"; then
