...
! **********************************************************************
...
#endif
#if defined HAVE_CLIB
  write(tmp,"(1x,a25)") "HAVE_CLIB"
  msg = trim(msg)//trim(tmp)
  msg_index = msg_index + 1
  if ( mod(msg_index,3) == 0 ) then
    msg = trim(msg)//ch10
  ...
  write(tmp,"(1x,a25)") "HAVE_DFT_LIBXC_GET_NUMBER"
  msg = trim(msg)//trim(tmp)
  msg_index = msg_index + 1
  if ( mod(msg_index,3) == 0 ) then
    msg = trim(msg)//ch10
...
#endif
#if defined HAVE_LINALG_ELPA_NEW
  write(tmp,"(1x,a25)") "HAVE_LINALG_ELPA_NEW"
  msg = trim(msg)//trim(tmp)
  msg_index = msg_index + 1
  if ( mod(msg_index,3) == 0 ) then
    msg = trim(msg)//ch10
  ...
  write(tmp,"(1x,a25)") "HAVE_TRIO_LIBPSPIO"
  msg = trim(msg)//trim(tmp)
  msg_index = msg_index + 1
  if ( mod(msg_index,3) == 0 ) then
    msg = trim(msg)//ch10
