...
!!
!! PARENTS
!!      gstate,m_ebands,respfn,suscep,vtorho
!!
!! CHILDREN
!!      getnel,timab,wrtout
!!
...
#define ABI_FUNC 'newocc'
 ...
 use interfaces_62_occeig, except_this_one => newocc
...
!Local variables-------------------------------
 integer,parameter :: niter_max=120,nkpt_max=50
 integer :: cnt,cnt2,cnt3,ib,ii,ik,ikpt,is,isppol,nkpt_eff,option
 integer :: sign
...
& nelectlo,nkpt,nsppol,occ,occopt,option,tphysel,tsmear,tmp_unit,wtk)
...
& nelecthi,nkpt,nsppol,occ,occopt,option,tphysel,tsmear,tmp_unit,wtk)
...
&     nelectmid,nkpt,nsppol,occ,occopt,option,tphysel,tsmear,tmp_unit,wtk)
...
&     nelect_biased,nkpt,nsppol,occt,occopt,option,tphysel,tsmear,tmp_unit,wtk)
     occ(:)=occ(:)-occt(:)
...
&       nelectmid,nkpt,1,occt,occopt,option,tphysel,tsmear,tmp_unit,wtk)
...
&     ' newocc : new Fermi energy for spin ', is, ' is ',fermie,&
&     ' , with nelect=',nelectmid,ch10,&
&     '  Number of bissection calls =',ii
     call wrtout(std_out,message,'COLL')
