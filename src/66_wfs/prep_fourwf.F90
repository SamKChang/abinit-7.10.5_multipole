...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2015 ABINIT group (FBottin,MT,GZ,FDahm)
...
subroutine prep_fourwf(rhoaug,blocksize,cwavef,wfraug,iblock,ikpt,istwf_k,mgfft,&
...
&          bandfft_kpt_tab,use_gpu_cuda) ! Optional arguments
 ...
 use m_bandfft_kpt,only : bandfft_kpt_type,bandfft_kpt
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: blocksize,iblock,ikpt,istwf_k,mgfft,n4,n5,n6,nband_k,ndat,npw_k
...
!arrays
 ...
 real(dp),intent(inout) :: cwavef(2,npw_k*blocksize)
