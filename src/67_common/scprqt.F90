...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (XG,AF)
...
!!
!! CHILDREN
!!      exit_check,prteigrs,wrtout,xc_vdw_trigger
!!
!! SOURCE
...
!  FIXME: this test should be done on input, not during calculation
     if((ttoldff == 1 .or. ttolrff == 1) .and. prtfor==0 )then
       MSG_BUG('toldff only allowed when prtfor=1 !')
     end if
