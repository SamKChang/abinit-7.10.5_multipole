...
!!
!! PARENTS
!!      hubbard_one,m_green,m_matlu,m_oper,qmc_prep_ctqmc
!!
!! CHILDREN
!!
!! SOURCE
...
!!
!! COPYRIGHT
!! Copyright (C) 2005-2014 ABINIT group (BAmadon)
!! This file is distributed under the terms of the
!! GNU General Public License, see ~abinit/COPYING
!! or http://www.gnu.org/copyleft/gpl.txt .
!!
...
!!
!! COPYRIGHT
!! Copyright (C) 2005-2013 ABINIT group (BAmadon)
!! This file is distributed under the terms of the
!! GNU General Public License, see ~abinit/COPYING
!! or http://www.gnu.org/copyleft/gpl.txt .
!!
